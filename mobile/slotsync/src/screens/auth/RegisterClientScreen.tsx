  ...
  return (
    <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
      ...
      <View style={styles.header}>
        <Text style={styles.title}>Client Account Registration</Text>
        <Text style={styles.subtitle}>Sign up to discover creators and book appointments</Text>
      </View>
      ...
      <View style={styles.form}>
        ...
        >
          {loading ? (
            ...
            <Text style={styles.submitButtonText}>Create Client Account</Text>
          )}
        </TouchableOpacity>
      </View>
    </ScrollView>
